...
\end{center}
\caption[Abbildung 3: runlevel 2 wird ausgeschaltet]{runlevel 2 wird ausgeschaltet}
\end{figure}
...
\end{center}
\caption[Abbildung 11: xinet tftp config]{xinet tftp config}
\end{figure}
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.75\textwidth]{bilder/screens/Part_3/b6_7.png}
\end{center}
\caption[Abbildung 12: vi tftp service]{vi tftp service}
\end{figure}
...
\end{center}
\caption[Abbildung 13: chkconfig]{chkconfig}
\end{figure}
...
\end{center}
\caption[Abbildung 16: chkconfig --level]{chkconfig --level}
\end{figure}
...
\end{center}
\caption[Abbildung 17: vsftpd runlevels]{vsftpd runlevels}
\end{figure}
...
\end{center}
\caption[Abbildung 18: chkconfig --level]{chkconfig --level}
\end{figure}
...
\end{center}
\caption[Abbildung 19: vsftpd runlevels]{vsftpd runlevels}
\end{figure}
9)\# Explain the function of xinetd \\
...
\end{center}
\caption[Abbildung 20: Netzwek Interface aktivieren]{Netzwek Interface aktivieren}
\end{figure}

\newpage \section*{Exercise 7: Configure the following network (figure 1) using ifconfig and route add}
...
\end{center}
\caption[Abbildung 21: Netzwerk figure 1]{Netzwerk figure 1}
\end{figure}
...
\end{center}
\caption[Abbildung 22: ifconfig Server München (Routing-Tabelle)]{ ifconfig Server München}
\end{figure}
...
\end{center}
\caption[Abbildung 23: Server München Routing-Tabelle anwenden]{Server München Routing-Tabelle anwenden}
\end{figure}

\newpage \textbf{Konfigurationsdatei von WEB-Hannover:(Routing-Tabelle)} \\
...
\end{center}
\caption[Abbildung 24: ifconfig Webserver Hannover (Routing-Tabelle)]{ifconfig Webserver Hannover}
\end{figure}
...
\end{center}
\caption[Abbildung 25: Webserver Hannover Routing-Tabelle anwenden]{Webserver Hannover  Routing-Tabelle anwenden}
\end{figure}
...
\end{center}
\caption[Abbildung 26: ifconfig Server Berlin (Routing-Tabelle)]{ifconfig Server Berlin}
\end{figure}
...
\end{center}
\caption[Abbildung 27: Server Berlin Routing-Tabelle anwenden]{Server Berlin  Routing-Tabelle anwenden}
\end{figure}
...
\end{center}
\caption[Abbildung 28: ifconfig Server Hamburg (Routing-Tabelle)]{ifconfig Server Hamburg}
\end{figure}
...
\end{center}
\caption[Abbildung 29: Server Hamburg Routing-Tabelle anwenden]{Server Hamburg Routing-Tabelle anwenden}
\end{figure}
...
\end{center}
\caption[Abbildung 30: ifconfig Router 1 (Routing-Tabelle)]{ifconfig Router 1}
\end{figure}
...
\end{center}
\caption[Abbildung 31: Router 1 Routing-Tabelle anwenden]{Router 1 Routing-Tabelle anwenden}
\end{figure}
...
\end{center}
\caption[Abbildung 32: ifconfig Router 2 (Routing-Tabelle)]{ifconfig Router 2}
\end{figure}
...
\end{center}
\caption[Abbildung 33: Router 2 Routing-Tabelle anwenden]{Router 2 Routing-Tabelle anwenden}
\end{figure}
...
\end{center}
\caption[Abbildung 34: ifconfig Router 3 (Routing-Tabelle)]{ifconfig Router 3}
\end{figure}
...
\end{center}
\caption[Abbildung 35: Router 3 Routing-Tabelle anwenden]{Router 3 Routing-Tabelle anwenden}
\end{figure}
Please use Kali Linux as root:
\# zenmap\\
Scan the networks:\\
...
\newpage Das Netz 10.88.40.64/27 wird gescannt:
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.6\textwidth]{bilder/screens/Part_3/exercise_7/b18.png}
\end{center}
...
\end{center}
\caption[Abbildung 40: Konfig. Server München mit ip addr]{Konfig. Server München ip addr}
\end{figure}
...
\end{center}
\caption[Abbildung 41: Konfig. Router 3 mit ip addr]{Konfig. Router 3 ip addr}
\end{figure}

\newpage \textbf{Gleiche Konfigurationsdatei von Router 3 mittels nmcli (Routing-Tabelle)}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_3/exercise_8/2rou3nmcli.png}
\end{center}
\caption[Abbildung 42: Konfig. Router 3 mit nmcli]{Konfig. Router 3 nmcli}
\end{figure}
...
\end{center}
\caption[Abbildung 43: Konfig. Router 2 mit ip addr]{Konfig. Router 2 ip addr}
\end{figure}

\newpage \textbf{Gleiche Konfigurationsdatei von Router 2 mittels nmcli (Routing-Tabelle)}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_3/exercise_8/3rou2nmcli.png}
\end{center}
\caption[Abbildung 44: Konfig. Router 2 mit nmcli]{Konfig. Router 2 nmcli}
\end{figure}
...
\end{center}
\caption[Abbildung 45: Konfig. Router 1 mit ip addr]{Konfig. Router 1 ip addr}
\end{figure}
...
\end{center}
\caption[Abbildung 46: Konfig. Router 1 mit nmcli]{Konfig. Router 1 nmcli}
\end{figure}

\newpage \textbf{Konfigurationsdatei von Webserver Hannover mittels ip addr (Routing-Tabelle)}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_3/exercise_8/5webhnip.png}
\end{center}
\caption[Abbildung 47: Konfig. Webserver Hannover mit ip addr]{Konfig.  Webserver Hannover ip addr}
\end{figure}
...
\end{center}
\caption[Abbildung 48: Konfig. Server Berlin mit nmcli]{Konfig.  Server Berlin nmcli}
\end{figure}
...
\newpage \textbf{Konfigurationsdatei von Server Hamburg mittels ip addr (Routing-Tabelle)}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_3/exercise_8/7svrhhip.png}
\end{center}
\caption[Abbildung 49: Konfig. Server Hamburg mit ip addr]{Konfig. Server Hamburg ip addr}
\end{figure}
...
\end{center}
\newpage Damit alle Änderungen für diesen Host übernommen werden bestätigen wir noch mal mit Apply.
...
\newpage IP Adresse für das Interface ens37 festlegen: \\
...
\newpage \textbf{Konfiguration von Webserver Hannover über die GUI:}  \\
...
\newpage
\begin{center}
\textbf{Scan des Subnetztes 10.88.40.128/27}\\
\end{center}
...
\end{center}
\caption[Abbildung 50: figure 1 LAN]{Netzwerk mit allen Hosts und Subnetzen}
\end{figure}
...
\end{center}
\caption[Abbildung 51: Zenmap Subnetz 64]{Subnetz 10.88.40.64/27}
\end{figure}
...
\end{center}
\caption[Abbildung 52: Zenmap Subnetz 96]{Subnetz 10.88.40.96/27}
\end{figure}
...
\end{center}
\caption[Abbildung 53: Zenmap Subnetz 128]{Subnetz 10.88.40.128/27}
\end{figure}
...
\end{center}
\caption[Abbildung 54: Zenmap Subnetz 160]{Subnetz 10.88.40.160/27}
\end{figure}
...
\end{center}
\caption[Abbildung 55: Zenmap Subnetz 32]{Subnetz 10.88.40.32/27}
\end{figure}

\newpage \textbf{Solution of c) Use Zenmap to scan all the above networks}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.55\textwidth]{bilder/screens/Part_4/Exercise_1/zAlle.PNG} 
\end{center}
\caption[Abbildung 56: Zenmap alle Subnetze]{Alle Subnetze}
\end{figure}
...
\end{center}
\caption[Abbildung 57: nmap command 1]{nmap -sS -O 10.88.40.130}
\end{figure}
...
\end{center}
\caption[Abbildung 58: nmap command 2]{nmap -sF 10.88.40.128 -oN outfile}
\end{figure}
...
\end{center}
\caption[Abbildung 59: nmap externes Logfile]{externes Logfile}
\end{figure}
...
\end{center}
\caption[Abbildung 60: nmap command 3]{nmap -sS 10.88.40.130 -D 10.88.40.36}
\end{figure}
...
\end{center}
\caption[Abbildung 61: nmap command 4]{nmap -sS -O 10.88.40.160/27}
\end{figure}
...
\end{center}
\caption[Abbildung 62: nmap command 5]{nmap -sP -PS 10.88.40.130}
\end{figure}
...
\end{center}
\caption[Abbildung 63: nmap command 6]{nmap -sP -PS25 10.88.40.130}
\end{figure}
...
\end{center}
\caption[Abbildung 64: nmap command 7]{nmap -sP -PS80 10.88.40.130/27}
\end{figure}

\newpage \textbf{Question 8:}  Please type and explain the nmap command: nmap -sP -PS53 10.88.X.?/27\\ 
...
\end{center}
\caption[Abbildung 65: nmap command 8]{nmap -sP -PS53 10.88.40.130/27}
\end{figure}
...
\end{center}
\caption[Abbildung 66: nmap command 9]{nmap -sS -v 10.88.40.130}
\end{figure}
...
\end{center}
\caption[Abbildung 67: nmap command 10]{nmap -sP -v 10.88.40.130}
\end{figure}
...
\newpage \textbf{Solution of 1)} Download Nessus from www.nessus.org (Linux Version Nessus-6.11.2-
es7.x86\_64.rpm) \\
...
\end{center}
\caption[Abbildung 68: installation Nessus]{Installation von Nessus im Terminal}
\end{figure}
...
\newpage Jetzt kann mit der Konfiguration gestartet warden.

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/install_nessus/3.PNG} 
\end{center}
\caption[Abbildung 69: Konfiguration Nessus]{Nessus Konfiguration Startseite}
\end{figure}
...
\end{center}
\caption[Abbildung 70:  Registrierung Nessus]{Nessus Registrierung}
\end{figure}
...
\end{center}
\caption[Abbildung 71:  Aktivierung Nessus]{Nessus Aktivierungskey}
\end{figure}
...
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/install_nessus/activeKey.PNG} 
\end{center}
\caption[Abbildung 72:  License Nessus]{Nessus License}
\end{figure}
...
\end{center}
\caption[Abbildung 73:  Scan Hosts in Subnetzt 10.88.40.32/27]{Scan des Subnetztes 10.88.40.32/27}
\end{figure}
...
\end{center}
\caption[Abbildung 74:  Ergebnis des Scans im Subnetz 10.88.40.32/27]{Alle Hosts im Subnetz 10.88.40.32/27}
\end{figure}
...
\end{center}
\caption[Abbildung 75:  Scan Hosts in Subnetzt 10.88.40.64/27]{Scan des Subnetztes 10.88.40.64/27}
\end{figure}
...
\end{center}
\caption[Abbildung 76:  Ergebnis des Scans im Subnetz 10.88.40.64/27]{Alle Hosts im Subnetz 10.88.40.64/27}
\end{figure}

\newpage \textbf{Scan des Subnetzes 10.88.40.96/27:} \\

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/install_nessus/nessus/96/s96.PNG} 
\end{center}
\caption[Abbildung 77:  Scan Hosts in Subnetzt 10.88.40.96/27]{Scan des Subnetztes 10.88.40.96/27}
\end{figure}
...
\end{center}
\caption[Abbildung 78:  Ergebnis des Scans im Subnetz 10.88.40.96/27]{Alle Hosts im Subnetz 10.88.40.96/27}
\end{figure}

\newpage \textbf{Scan des Subnetzes 10.88.40.128/27:} \\

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/install_nessus/nessus/128/s128.PNG} 
\end{center}
\caption[Abbildung 79: Scan Hosts in Subnetzt 10.88.40.128/27]{Scan des Subnetztes 10.88.40.128/27}
\end{figure}
...
\end{center}
\caption[Abbildung 80:  Ergebnis des Scans im Subnetz 10.88.40.128/27]{Alle Hosts im Subnetz 10.88.40.128/27}
\end{figure}

\newpage \textbf{Scan des Subnetzes 10.88.40.160/27:} \\

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/install_nessus/nessus/160/s160.PNG} 
\end{center}
\caption[Abbildung 81:  Scan Hosts in Subnetzt 10.88.40.160/27]{Scan des Subnetztes 10.88.40.160/27}
\end{figure}
...
\end{center}
\caption[Abbildung 82:  Ergebnis des Scans im Subnetz 10.88.40.160/27]{Alle Hosts im Subnetz 10.88.40.160/27}
\end{figure}
...
\end{center}
\caption[Abbildung 83:  Ergebnis des Scans aller Subnetze]{Alle Subnetze}
\end{figure}
...
\end{center}
\caption[Abbildung 84: Netzwerkkonfiguration über die GUI]{Netzwerkkonfiguration über die GUI}
\end{figure}
...
\end{center}
\caption[Abbildung 85: erfolgreiche Internetverbindung]{erfolgreiche Internetverbindung}
\end{figure}
...
\newpage \textbf{Do the following steps to install and run OpenVAS:}\\
...
\end{center}
\caption[Abbildung 86: apt-get update]{apt-get update}
\end{figure}
...
\end{center}
\caption[Abbildung 87: apt-get upgrade]{apt-get upgrade}
\end{figure}
...
\end{center}
\caption[Abbildung 88: OpenVas Installation]{OpenVas Installation}
\end{figure}

\newpage Anschließend haben wir OpenVas eingerichtet, indem wir folgenden Kommando in den Terminal eingegeben haben: openvas-setup. Wie der Name bereits verrät ist dieser Kommando für die Einrichtung für OpenVAS da.

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/openvas/8.PNG} 
\end{center}
\caption[Abbildung 89: OpenVas Konfiguration]{OpenVas Konfiguration}
\end{figure}
...
\end{center}
\caption[Abbildung 90: OpenVas user anlegen]{user anlegen}
\end{figure}
...
\end{center}
\caption[Abbildung 91: OpenVas Login]{Login OpenVas}
\end{figure} 
...
\newpage \textbf{Scan des Subnetzes 10.88.40.32/27:}

\begin{figure}[H]
\begin{center}
\includegraphics[width=0.9\textwidth]{bilder/screens/Part_4/Exercise_3/openvas/n32.PNG} 
\end{center}
\caption[Abbildung 92: OpenVas Scan des Subnetzes 10.88.40.32/27]{Scan des Subnetzes 10.88.40.32/27}
\end{figure} 
...
\end{center}
\caption[Abbildung 93: OpenVas Scan des Subnetzes 10.88.40.64/27]{Scan des Subnetzes 10.88.40.64/27}
\end{figure} 
...
\end{center}
\caption[Abbildung 94: OpenVas Scan des Subnetzes 10.88.40.96/27]{Scan des Subnetzes 10.88.40.96/27}
\end{figure} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.7\textwidth]{bilder/screens/Part_4/Exercise_3/openvas/n128.PNG} 
\end{center}
\caption[Abbildung 95: OpenVas Scan des Subnetzes 10.88.40.128/27]{Scan des Subnetzes 10.88.40.128/27}
\end{figure} 
...
\end{center}
\caption[Abbildung 96: OpenVas Scan des Subnetzes 10.88.40.160/27]{Scan des Subnetzes 10.88.40.160/27}
\end{figure} 
...
\end{center}
\caption[Abbildung 97: OpenVas Scan alle Subnetze]{Scan aller Subnetze}
\end{figure} 
...
\end{center}
\caption[Abbildung 98: Figur 1]{ Abbildung Figur 1}
\end{figure}

\begin{figure}[H]
\begin{center}
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/karan/2.PNG} 
\end{center}
\caption[Abbildung 99: Figur 2]{ Abbildung Figur 2}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.4\textwidth]{bilder/screens/Part_5/karan/3.PNG} 
\end{center}
\caption[Abbildung 100: install nmap-frontend] {Abbildung install nmap-frontend}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.4\textwidth]{bilder/screens/Part_5/karan/4.PNG} 
\end{center}
\caption[Abbildung 101: install nmap-frontend 2] {Abbildung install nmap-frontend 2}
\end{figure}
...
\end{center}
\caption[Abbildung 102: pnid4-mid-hh nach pnid4-cnt-bln] {pnid4-mid-hh nach pnid4-cnt-bln}
\end{figure}
...
\end{center}
\caption[Abbildung 103: pnid4-mid-hh nach pnid4-cnt-bln 2] {Abbildung pnid4-mid-hh nach pnid4-cnt-bln 2}
\end{figure}
...
\end{center}
\caption[Abbildung 104: pnid4-cnt-bln nach pnid4-mid-hh] {Abbildung pnid4-cnt-bln nach pnid4-mid-hh}
\end{figure}
...
\end{center}
\caption[Abbildung 105: pnid4-cnt-bln nach pnid4-mid-hh 2] {Abbildung pnid4-cnt-bln nach pnid4-mid-hh 2}
\end{figure}

\newpage \section*{Exercise 2: Getting started with network monitoring tools}
...
\newpage In den theoretischen Grundlagen wurde bereits der Ausdruck Sniffing erklärt.Dies wird in diesem Aufgabenteil nochmal aufgegriffen, da wir hier die Sniffing-Tools Wireshark und Tcpdump nutzen.\\
...
\end{center}
\caption[Abbildung 106: installation wireshark] {Abbildung installation wireshark}
\end{figure}
...
\end{center}
\caption[Abbildung 107: installation libsmi] {Abbildung installation libsmi}
\end{figure}
...
\end{center}
\caption[Abbildung 108: installation httpd] {Abbildung installation httpd}
\end{figure}
...
\end{center}
\caption[Abbildung 109: installation httpd 2] {Abbildung installation httpd 2}
\end{figure}
...
\end{center}
\caption[Abbildung 110: installation tcpdump] {Abbildung installation tcpdump}
\end{figure}
...
\end{center}
\caption[Abbildung 111: installation telnet] {Abbildung installation telnet}
\end{figure}
...
\end{center}
\caption[Abbildung 112: installation wireshark] {Abbildung installation wireshark}
\end{figure}
...
\end{center}
\caption[Abbildung 113: Apache aktivieren] {Abbildung Apache aktivieren}
\end{figure}
...
\end{center}
\caption[Abbildung 114: Verbindung zum http Server] {  Verbindung zum http Server}
\end{figure}
...
\end{center}
\caption[Abbildung 115: Wireshark Analyse] {Wireshark Analyse}
\end{figure}
...
\end{center}
\caption[Abbildung 116 Tcpdump Analyse] {Tcpdump Analyse}
\end{figure}
...
\end{center}
\caption[Abbildung 117: tcpdump -i ens33] {tcpdump -i ens33}
\end{figure}
...
\end{center}
\caption[Abbildung 118: tcpdump -c 12 -i ens33 ] {tcpdump -c 12 -i ens33}
\end{figure}
...
\end{center}
\caption[Abbildung 119: tcpdump -c 12 -i ens33 ] {tcpdump -c 12 -i ens33}
\end{figure}
...
\newpage 1.	Start your virtual machine pnidX-mid-hh with IP-address 10.88.X.$\Delta$\\
2.	Login as root. \\
...
\end{center}
\caption[Abbildung 120: Telnet mid-hh to cnt-bln ] {Telnet mid-hh to cnt-bln}
\end{figure}
...
\end{center}
\caption[Abbildung 121: tcpdump -vvv ] {tcpdump -vvv}
\end{figure}
...
\end{center}
\caption[Abbildung 122: telnet trump4 ] {telnet trump4 }
\end{figure}
...
\end{center}
\caption[Abbildung 123: pnidX-mid-hh-dump.1 ] {pnidX-mid-hh-dump.1}
\end{figure}
...
\end{center}
\caption[Abbildung 124: ssh 10.88.40.37 ] {ssh 10.88.40.37}
\end{figure}

\newpage 12.	Examine the pnidX-mid-hh-dump.2 \\\\
...
\end{center}
\caption[Abbildung 125: pnidX-mid-hh-dump.2] {pnidX-mid-hh-dump.2}
\end{figure}
...
\end{center}
\caption[Abbildung 126:  pnidX-mid-hh-dump.2] {pnidX-mid-hh-dump.2}
\end{figure}
...
\end{center}
\caption[Abbildung 127:  pnidX-mid-hh-dump.2] {pnidX-mid-hh-dump.2}
\end{figure}
...
\end{center}
\caption[Abbildung 128: pnidX-mid-hh-dump.3] {pnidX-mid-hh-dump.3}
\end{figure}

\newpage Q10: Now answer the following questions: \\\\
1.	What is the difference in the three tcpdump commands? In their outputs?
\\Der Kommand tcpdump -i eth4 -vvv  > pnid4-cnt-bln-dump.1 gibt sehr viele Infromationen aus. Je mehr -v Paramaeter im Kommando verwendet werden desto, mehr Details werden bereitgestellt. \\\\
...
Bei Verwendung des Befehlst tcpdump -x >  pnid4-cnt-bln.dump.3 werden die Pakete als Hexadezimalcode ausgegeben.\\\\
...
\end{center}
\caption[Abbildung 129: Wireshark Filter 1]{Wireshark Filter ip.addr == 10.88.40.70}
\end{figure}
...
\end{center}
\caption[Abbildung 130: Wireshark Filter 2]{Wireshark Filter ip.addr == 10.88.40.70 \&\& frame.len > 400}
\end{figure}
...
\end{center}
\caption[Abbildung 131:  Wireshark Filter 3]{Wireshark Filter ip.addr == 10.88.40.70 \&\& (frame.number > 15 \&\& frame.number < 30)}
\end{figure}
...
\end{center}
\caption[Abbildung 132: Wireshark Filter 4]{Wireshark Filter ip.dst == 10.88.40.70 and tcp.port == 23}
\end{figure}
...
\end{center}
\caption[Abbildung 133: Wireshark Filter 5]{Wireshark Filter host 10.88.40.70 \&\& tcp port 23}
\end{figure}

\newpage \textbf{Question 6:} Please type and examine the syntax for a Wireshark command which, by default, collects packets with source or destination IP address 10.88.X.? on interface eth4. \\
...
\end{center}
\caption[Abbildung 134: Wireshark Filter 7]{Wireshark Filter ip.addr == 10.88.40.70 \&\& tcp.port == 23}
\end{figure}
...
\end{center} 
\caption[Abbildung 135: Wireshark Filter 8]{Wireshark Filter ftp}
\end{figure}
...
\caption[Abbildung 136: Wireshark ftp Login Passwort]{Wireshark ftp Login Passwort}
\end{center} 
\end{figure}
...
\end{center} 
\caption[Abbildung 137: Wireshark Filter 9]{Wireshark Filter ssh}
\end{figure}
...
\end{center} 
\caption[Abbildung 138: Wireshark ssh Datenpaket]{Wireshark verschlüsselte Datenfragmente}
\end{figure}
...
\end{center} 
\caption[Abbildung 139: nmap offene Ports anzeigen]{Zeigt uns die offenen Ports an}
\end{figure}
...
\end{center} 
\caption[Abbildung 140: Telnet login]{Anmeldung via Telnet}
\end{figure}
...
\end{center} 
\caption[Abbildung 141: Installation Openswan]{Installation Openswan}
\end{figure} 
...
\end{center} 
\caption[Abbildung 142: Figure 1: HOST-TO-HOST-VPN]{Figure 1: HOST-TO-HOST-VPN}
\end{figure}
...
\end{center} 
\caption[Abbildung 143: dst 10.88.40.130 \&\& tcp \&\& port 80]{dst 10.88.40.130 \&\& tcp \&\& port 80}
\end{figure}
...
\end{center} 
\caption[Abbildung 144: http://10.88.40.130]{http://10.88.40.130}
\end{figure}
...
\end{center} 
\caption[Abbildung 145: Filter: dst 10.88.40.130 \&\& tcp \&\& port 80]{Filter: dst 10.88.40.130 \&\& tcp \&\& port 80}
\end{figure}
...
\end{center} 
\caption[Abbildung 146: ipsec ranbits 256 >]{ipsec ranbits 256 >}
\end{figure}
...
\end{center} 
\caption[Abbildung 147: psk.secrets]{psk.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 148: psk.conf]{psk.conf}
\end{figure}
...
\end{center} 
\caption[Abbildung 149: ipsec setup reload]{ipsec setup reload}
\end{figure}
...
\end{center} 
\caption[Abbildung 150: ipsec auto --add]{ipsec auto --add}
\end{figure}
...
\end{center} 
\caption[Abbildung 151: ipsec auto --up]{ipsec auto --up}
\end{figure}
...
\end{center} 
\caption[Abbildung 152: iptables rules]{iptables rules}
\end{figure}
...
\end{center} 
\caption[Abbildung 153: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 154: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\end{center} 
\caption[Abbildung 155: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 156: ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 157:  ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 158: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 159: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 160: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\end{center} 
\caption[Abbildung 161: /etc/ipsec\_iptables]{/etc/ipsec\_iptables}
\end{figure}
...
\end{center} 
\caption[Abbildung 162: ipsec\_ifconfig.dump]{ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 163: ipsec\_look.dump]{ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 164: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 165: dst 10.88.40.130 \&\& tcp port 80]{dst 10.88.40.130 \&\& tcp port 80}
\end{figure}
...
\end{center} 
\caption[Abbildung 166: Berlin: certutil -N -d /etc/ipsec.d]{certutil -N -d /etc/ipsec.d}
\end{figure}
...
\end{center} 
\caption[Abbildung 167: Hamburg: certutil -N -d /etc/ipsec.d]{certutil -N -d /etc/ipsec.d}
\end{figure}
...
\end{center} 
\caption[Abbildung 168: ipsec newhostkey 1]{ipsec newhostkey 1}
\end{figure}
...
\end{center} 
\caption[Abbildung 169: ipsec newhostkey 2]{ipsec newhostkey 2}
\end{figure}
...
\end{center} 
\caption[Abbildung 170: rsa.conf]{rsa.conf}
\end{figure}
...
\end{center} 
\caption[Abbildung 171: ipsec setup reload]{ipsec setup reload}
\end{figure}
...
\end{center} 
\caption[Abbildung 172: ipsec setup reload]{ipsec setup reload}
\end{figure}
...
\end{center} 
\caption[Abbildung 173: ipsec auto - - add rsa]{ipsec auto - - add rsa}
\end{figure}
...
\end{center} 
\caption[Abbildung 174: ipsec auto - - up rsa]{ipsec auto - - up rsa}
\end{figure}
...
\end{center} 
\caption[Abbildung 175: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_7/ii/bln/3.PNG} 
\end{center} 
\caption[Abbildung 176: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_7/iii/bln/1.PNG} 
\end{center} 
\caption[Abbildung 177: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 178:  ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 179:  ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 180: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 181: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 182: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_7/iii/mid/3.PNG} 
\end{center} 
\caption[Abbildung 183: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 184: ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 185: ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 186: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\newpage i) Test connectivity between pnidX-mid-hh and pnidX-cnt-bln using ping,
...
\end{center} 
\caption[Abbildung 187: ping-Ergebnis]{ping-Ergebnis}
\end{figure}
...
\end{center} 
\caption[Abbildung 188: zenmap for testing the connectivity]{zenmap for testing the connectivity}
\end{figure}
...
\end{center} 
\caption[Abbildung 189: net-to-net-psk.secrets]{net-to-net-psk.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 190: net-to-net-psk.conf]{net-to-net-psk.conf}
\end{figure}
...
\newpage iv) Secure the computer traffic by creating iptables rules to permit only IPSec traffic between the two gateways. All other, non-IPSec packets must be denied.\\
...
\end{center} 
\caption[Abbildung 191: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 192: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_8/iv/03.PNG} 
\end{center} 
\caption[Abbildung 193: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 194: ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 195: ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 196: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 197: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 198: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_8/iv/02.PNG} 
\end{center} 
\caption[Abbildung 199: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 200: ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 201: ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 202: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\newpage \textbf{Ping between pnid4-mid-hh and pnid4-cnt-bln}
\begin{figure}[H]
\begin{center}
...
\newpage iii) Establish a tunnelled IPSec connection, using the RSA Method between the
...
\newpage \textbf{b)} \verb|ipsec newhostkey --configdir /etc/ipsec.d/ --output /etc/ipsec.d/keys.secrets|\\
\textbf{Der Befehl generiert 2 RSA Authentifikationsschlüssel für die beiden Gateways.}

\textbf{net-to-net-rsa.secrets}
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\textwidth]{bilder/screens/Part_5/aufgabe_9/iii/bln/2.PNG} 
\end{center} 
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=0.8\textwidth]{bilder/screens/Part_5/aufgabe_9/iii/hh/2.PNG} 
\end{center} 
...
\end{center} 
\caption[Abbildung 203: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 204: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_9/iv/1.PNG} 
\end{center} 
\caption[Abbildung 205: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 206:  ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 207:  ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 208: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
...
\newpage \textbf{1) /etc/ipsec.secrets }\\
\begin{figure}[H]
\begin{center}
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_9/v/hh/2.PNG} 
\end{center} 
\caption[Abbildung 209: /etc/ipsec.secrets]{/etc/ipsec.secrets}
\end{figure}
...
\end{center} 
\caption[Abbildung 210: /etc/ipsec.conf]{/etc/ipsec.conf}
\end{figure}
...
\includegraphics[width=1\textwidth]{bilder/screens/Part_5/aufgabe_9/iv/2.PNG} 
\end{center} 
\caption[Abbildung 211: /etc/ipsec\_iptables ]{/etc/ipsec\_iptables }
\end{figure}
...
\end{center} 
\caption[Abbildung 212:  ipsec\_ifconfig.dump]{ ipsec\_ifconfig.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 213: ipsec\_look.dump]{ ipsec\_look.dump}
\end{figure}
...
\end{center} 
\caption[Abbildung 214: ipsec\_route.dump]{ipsec\_route.dump}
\end{figure}
